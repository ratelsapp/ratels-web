...
import { Alert, Snackbar, Typography, Menu, MenuItem, ListItemIcon } from '@mui/material'
...
const Header = () => {
  ...
  const [anchorElAccounts, setAnchorElAccounts] = useState<null | HTMLElement>(null)
