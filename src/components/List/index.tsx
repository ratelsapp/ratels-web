...
const header = [
  ...
  {
    title: "Twitter verification time",
    dataIndex: "twitterTime",
    key: "twitterTime",
  },
  { title: "Discord", dataIndex: "discord", key: "discord" },
  {
    title: "Discord verification time",
    dataIndex: "discordTime",
    key: "discordTime",
  },
  { title: "Github", dataIndex: "github", key: "github" },
  {
    title: "Github verification time",
    dataIndex: "githubTime",
    key: "githubTime",
  },
];
    ...
    <div className="resultList">
      ...
      {list.length > 0 && (
        <div className="downloadWrap">
          ...
          <div className="downloadWrap_text" onClick={handleDownload}>
            Download
          </div>
        </div>
      )}
      {list.map((item) => (
        <Detail data={item} key={item.account} />
      ))}
    </div>
  );
};
