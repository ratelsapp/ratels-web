export default ({ IDL }) => {
  ...
  const nft = IDL.Service({
    ...
    getAllPayments: IDL.Func([], [IDL.Vec(IDL.Tuple(IDL.Principal, IDL.Vec(SubAccount_3)))], ["query"]),
    getBuyers: IDL.Func([], [IDL.Vec(IDL.Tuple(AccountIdentifier_3, IDL.Vec(TokenIndex)))], ["query"]),
    ...
    reserve: IDL.Func([IDL.Nat64, AccountIdentifier_3, SubAccount_3], [Result_7], []),
    retreive: IDL.Func([AccountIdentifier_3], [Result_6], []),
    salesSettlements: IDL.Func([], [IDL.Vec(IDL.Tuple(AccountIdentifier_3, Sale))], ["query"]),
    salesStats: IDL.Func([], [IDL.Bool, IDL.Nat32, IDL.Nat32, IDL.Nat, IDL.Tuple(IDL.Nat64, TokenIndex)], ["query"]),
