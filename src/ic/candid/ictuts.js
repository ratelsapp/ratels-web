export default ({ IDL }) => {
  ...
  const nft_canister = IDL.Service({
    ...
    allPayments: IDL.Func([], [IDL.Vec(IDL.Tuple(IDL.Principal, IDL.Vec(SubAccount_3)))], ["query"]),
    ...
    failedSales: IDL.Func([], [IDL.Vec(IDL.Tuple(AccountIdentifier_3, SubAccount_3))], ["query"]),
    ...
    lock: IDL.Func([TokenIdentifier_2, IDL.Nat64, AccountIdentifier_3, SubAccount_3], [Result_9], []),
    metadata: IDL.Func([TokenIdentifier_2], [Result_8], ["query"]),
    mintAndList: IDL.Func([AccountIdentifier_3, IDL.Opt(IDL.Vec(IDL.Nat8)), IDL.Nat64, IDL.Text], [TokenIndex], []),
    ...
    reserve: IDL.Func([IDL.Nat64, IDL.Nat64, AccountIdentifier_3, SubAccount_3], [Result_7], []),
    retreive: IDL.Func([AccountIdentifier_3], [Result_6], []),
    salesSettlements: IDL.Func([], [IDL.Vec(IDL.Tuple(AccountIdentifier_3, Sale))], ["query"]),
    salesStats: IDL.Func([AccountIdentifier_3], [IDL.Bool, IDL.Nat, IDL.Nat, IDL.Nat64], ["query"]),
